...
steps_per_second = [num_steps/x for x in times]

print("Total iterations: ", num_iterations)
print("Average total time: %f s", sum(times) / len(times))
print("Average Steps / second: ", sum(steps_per_second) / len(steps_per_second))
