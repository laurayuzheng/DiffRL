...
run_path = "/home/son/Documents/icml2023/DiffRL/icml2023_outputs/pacecar/2023_01_22/2_lane_2_auto_4_idm"
grad_ppo_path = run_path + "/grad_ppo"
ppo_path = run_path + "/ppo"
shac_path = run_path + "/shac"

mpath = {'grad_ppo': grad_ppo_path, 'ppo': ppo_path, 'shac': shac_path}
...
for method in ['grad_ppo', 'ppo', 'shac']:
    mcpath = mpath[method]
    ...
    for dir in dirs:
        ...
        rewards[method][dir] = out['rewards/time']
