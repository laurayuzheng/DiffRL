...
def create_dflex_env(**kwargs):
    ...
    env = env_fn(num_envs=cfg_train["params"]["config"]["num_actors"], \
        ...
        device=device,
        render_path=cfg_train['params']['general']['logdir'])
...
if __name__ == '__main__':
    ...
    cfg_train['params']['config']['max_epochs'] = 1
    cfg_train['params']['config']['gi_params']['num_step'] = 2000
    cfg_train['params']['config']['steps_num'] = 2000
    cfg_train['params']['load_checkpoint'] = True
    cfg_train['params']['load_path'] = cfg_train['params']['general']['checkpoint']
    cfg_train["params"]["config"]["num_actors"] = 1
    cfg_train["params"]["config"]["minibatch_size"] = 2000
