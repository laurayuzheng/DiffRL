...
class TrafficNoiseEnv(DFlexEnv):
    ...
    def __init__(self, render=False, device='cuda:0', num_envs=1, seed=0, episode_length=1000, 
        ...
        super(TrafficNoiseEnv, self).__init__(num_envs, num_obs, num_act, episode_length, MM_caching_frequency, seed, no_grad, render, device)
    ...
    def init_sim(self):
        self.sim = WorldSim(self.num_envs, self.num_idm_vehicle, max_vehicles=200, no_steering=True, device = self.device)
