...
from envs.traffic.bottleneck_flow.simulation import BottleneckSim
from highway_env.envs.common.graphics import EnvViewer

class TrafficBottleneckEnv(DFlexEnv):
    ...
    def __init__(self, render=False, device='cuda:0', num_envs=64, seed=0, 
        ...
        super(TrafficBottleneckEnv, self).__init__(num_envs, num_obs, num_act, episode_length, MM_caching_frequency, seed, no_grad, render, device)
    ...
    def init_sim(self):
        ...
        self.dt = 0.03
        self.sim = BottleneckSim(self.num_envs, 
